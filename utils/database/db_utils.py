...
# ) -> List[object]:
#     """
#     Return the database schema. This is used when pushing
#     data to a table or to just print the
...
#     json: bool
#         This will return the json form of the table schema.

#     Returns
#     -------
#     A list of `bigquery.SchemaField(...)` for the table.
